...
void MoodBites::pilihMood() {
    ...
    if (mood == 1) {
        cout << MERAH << "Yaah, kamu lagi sedih ya? Kami punya menu yang bisa bikin kamu lebih baik!\n" << RESET;
    } else if (mood == 2) {
        cout << MERAH << "Ciee lagi senang ya? Yuk coba menu-menu yang bikin mood kamu makin top!\n" << RESET;
    } else if (mood == 3) {
        cout << MERAH << "Gak apa-apa kok kalo lagi marah, coba deh menu-menu ini!\n" << RESET;
    } else if (mood == 4) {
        cout << MERAH << "Mungkin kamu lagi biasa aja, tapi ada menu yang pasti bikin kamu puas!\n" << RESET;
    }
}
